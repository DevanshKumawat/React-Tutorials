...
import { Link, NavLink } from 'react-router-dom';  // Link is used at the place of 'a' tag cause a tag cause the complete page refresh and Navlink is used coz it gives extra functionality 
